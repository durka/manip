...
#define beginCom(args)  (Serial1.begin(args), Serial2.begin(args))    // Begin Serial Comunication
#define endCom()        (Serial1.end(), Serial2.end())          // End Serial Comunication
...
inline void switchCom(unsigned char DirPin, unsigned char Mode)
{
    switch (Mode)
    {
        case Tx_MODE:
