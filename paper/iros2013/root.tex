...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \node (p1) at (-2.9,-2.5) {\usebox{\plotone}};
    \node (p2) at (0,-2.5) {\usebox{\plottwo}};
    \node (p3) at (2.8,-2.5) {\usebox{\plotthree}};
    \node (t2) at (-2.5,-5.2) {\usebox{\treetwo}};
    \node (t3) at (2.5,-5.2) {\usebox{\treethree}};
...
The MATLAB, Python and C++ code underlying the algorithms described in this paper may be found at {\hfil\penalty 100 \hfilneg \hbox{\url{http://www.alexburka.com/penn/manip.html}}}.
